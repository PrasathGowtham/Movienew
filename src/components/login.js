...
function Loginpage() {
    ...
    const handelSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            const responce = await axios.post("https://moviee.onrender.com/user/signin", { ...data });
            if (responce) {
        ...
        <div style={{ backgroundColor: "#8E8D8A" }} className="body">
            ...
            <div className="login row" >
                ...
                <div className="col-md-12">
                    ...
                    <div style={{ padding: "10px" }}> <span style={{ margin: "10px" ,color:"azure" }}>did't have an account?</span><a class="btn btn-secondary" href="#" role="button" onClick={() => navigate("/signup")}>Signup</a>
                    <p style={{color:"azure"}}>email:user123@gmail.com , password:123456</p>
                    </div>
                </div>
            </div>
        </div>
